 ...
 * 2026-02-06 ListAllFigures() /Groups add Logger.Warn if Count==0
*/
/*
    ...
    {   // order by hierachy / importance
        ...
        internal static BlockData SetBlockData(int lineStart, string element, int figNr)
        {
            ...
            { //            if (gcode.loggerTrace) Logger.Trace("setBlockData {0}", element);
                ...
                if (element.Contains("PenName")) { tmp.ToolName = GetAttributeValue(element, "PenName"); }
        ...
        public static void ListAllFigures()
        {
            ...
            { Logger.Warn("ListAllFigures Count 0"); }
        }
        ...
        internal static bool GetGroupByIndex(ref BlockData tmp, int i)
        {
            if ((listGroups.Count > 0) && (i >= 0) && (i < listGroups.Count))
            { tmp = listGroups[i]; return true; }
            return false;
        }
        ...
        public static void ListAllGroups()
        {
            ...
            { Logger.Warn("ListAllGroups Count 0"); }
        }
