...
namespace GrblPlotter
{
    ...
    {	// tool properties general
        ...
        public float SpindleSpeed { get; set; } // LaserPower; Servo-Val
//        public bool UseM3 { get; set; }
//        public bool UseAir { get; set; }
  //      public bool UseSorZ { get; set; }  // Plotter use S or Z
  //      public int Passes { get; set; }
        //    public OptionPropHatchFill FillToolListElements { get; set; }
        ...
        //    UseM3 = true; UseAir = false; Passes = 1;
            //   FillToolListElements = new OptionPropHatchFill();
        }
        ...
        public ToolProp Copy()
        {
            ToolProp other = (ToolProp)MemberwiseClone();
            //     other.FillToolListElements = FillToolListElements.Copy();
            return other;
        }
    ...
    {
        private const int toolTableMax = 260;            // max amount of toolProp
                ...
                try
                {
                    ...
                    foreach (string s in readText)
                    {
                        ...
                        if (s.Length > 25)
                        {
                            ...
                            toolTableArray.Add(new ToolProp());             // add empty property, FillToolListElements later
    ...
    //    public float NoiseDistance { get; set; }
