( Select water color nr. 2021-05-13)
( G53 indicates machine coordinates - no transform required)
M98 P93 					( Pen far up subroutine from main program)
G53 G90 G0 Y#TOAY			( move brush towards color pad in absolute machine coordinates)
G53 G90 G0 X#TOAX 			( move brush towards color pad in absolute machine coordinates)
